...
//for str1[1..m-1] and str2[0..n-1]. And then we can fix the first character of str2[0..n-1] and recursively call for str1[0..m-1] 
//and str2[1..n-1]. Thanks to akash01 for providing following C implementation.
